...
# test 1 
print("testing hello, expected  2")
test1= countVowels("hello")
print(test1)
...
# test 2 
print("testing action expected 3")
print(countVowels("Action"))
...
# test 1 
print(" testing 5 expected 11")
print(doublePlus(5))

# test 2

print("testing 6 expected 13")
print(doublePlus(6))
...
# test 1
print(" testing 3 expected 6")
print(factorial(3))

# test 2
print(" testing 8 expected 40320")
print(factorial(8))
...
# test 1
print(firstHalf("farm"))
print("testing farm expected fa")
# test 2
print(firstHalf("harm"))
print(" testing harm expected ha")